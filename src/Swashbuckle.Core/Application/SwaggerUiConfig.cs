...
using OrchardSwagger.SwaggerUi;

namespace OrchardSwagger.Application
{
    public class SwaggerUiConfig
    {
        ...
        public SwaggerUiConfig(IEnumerable<string> discoveryPaths, Func<HttpRequestMessage, string> rootUrlResolver)
        {
            ...
            CustomAsset("index", thisAssembly, "OrchardSwagger.SwaggerUi.CustomAssets.index.html", isTemplate: true);
            //CustomAsset("css/screen-css", thisAssembly, "OrchardSwagger.SwaggerUi.CustomAssets.screen.css");
            //CustomAsset("css/typography-css", thisAssembly, "OrchardSwagger.SwaggerUi.CustomAssets.typography.css");
        }
        ...
        {
            InjectJavaScript(GetType().Assembly, "OrchardSwagger.SwaggerUi.CustomAssets.discoveryUrlSelector.js");
        }
        ...
        private void MapPathsForSwaggerUiAssets()
        {
            ...
            {
                if (resourceName.Contains("OrchardSwagger.SwaggerUi.CustomAssets")) continue; // original assets only
